...
This a a test site for MkDocs + Material + Devcontainers. 

Goal is to have a working setup for a documentation site that can be run in a devcontainer, GitHub Codespaces or locally. Basic goals are: 
